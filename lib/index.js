...
internals.handler = function (route, handlerOptions) {
    ...
    return async function (request, h) {
        ...
        const _sendRequest = async function () {
        ...
        if (settings.onBeforeSendRequest) {
          return settings.onBeforeSendRequest(request)
            .then(function (requestUpdates) {
